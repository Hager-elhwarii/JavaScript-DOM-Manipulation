...
DOM stands for `Document Object Model`. It represents the structural pieces of a web document as objects that can be accessed and manipulated. So we can create, change, or remove elements from a website document, using Vanilla `JavaScript`.
